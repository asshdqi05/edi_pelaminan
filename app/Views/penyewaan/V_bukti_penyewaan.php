...
<div class="col-md-12">
    <div class="card card-primary card-outline">
        <div class="card-header">
            <a href="<?= site_url('C_sewa') ?>" class="btn btn-primary btn-flat">
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <th colspan="1"><?= "Rp " . number_format($data_bayar->denda) ?>
                                        
                                        <?php if($data_bayar->ket_denda==null){
                                            echo "";
                                        }else{ 
                                            echo "( $data_bayar->ket_denda )";
                                        }
                                         ?> </th>
                                    </tr>
                                    <tr>
                                ...
                                <?php } else if ($data_penyewaan->status_sewa == 1) {  ?>
                                    <tr>
                                        <th colspan="4">Status</th>
                                        <th colspan="2">
                                            <h3>Belum Lunas</h3>
                                ...
                                <?php }
                                if ($data_penyewaan->status_sewa == 4) { ?>
                                    <tr>
                                        <th colspan="4">Status</th>
                                        <th colspan="2">
                                            <h3>Batal</h3>
