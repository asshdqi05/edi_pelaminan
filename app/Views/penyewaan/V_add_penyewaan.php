...
<div class="card card-teal">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form action="<?= site_url('C_sewa/save_sewa') ?>" method="POST">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md">
                    <div class="form-group">
                        <label>Penyewa</label>
                        <input type="hidden" readonly class="form-control" id="id_penyewa" name="id_penyewa">
                        <div class="input-group">
                            <input type="text" readonly class="form-control" id="nama_penyewa" name="penyewa" required>
